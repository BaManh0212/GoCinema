    ...
    <form action="{{ route('admin.phim.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" 
                   name="dien_vien" 
                   value="{{ old('dien_vien') }}"
                   class="form-control @error('dien_vien') is-invalid @enderror" 
        ...
        <div class="mb-3">
            ...
            <input type="text" 
                   ...
                   value="{{ old('do_tuoi_gioi_han') }}"
                   class="form-control @error('do_tuoi_gioi_han') is-invalid @enderror" 
        ...
        <div class="mb-3">
            ...
            <input type="file" 
                   name="anh_poster" 
                   class="form-control @error('anh_poster') is-invalid @enderror" 
                   accept="image/*" 
