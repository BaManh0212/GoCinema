...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 text-gray-800 mb-3">Doanh thu combo</h1>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="card border-left-success shadow h-100">
                    <div class="card-body">
                        <div class="text-xs text-success text-uppercase mb-1">Tổng doanh thu</div>
            ...
            <div class="col-md-6 mb-3">
                <div class="card border-left-info shadow h-100">
                    <div class="card-body">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($summary['tong_so_luong']) }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow mb-3">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Theo combo</h6>
            </div>
        ...
        <div class="card shadow">
            ...
            <div class="card-body"><canvas id="chartComboDay" height="120"></canvas></div>
        </div>
    </div>
@endsection
...
@push('scripts')
    <script>
        (function() {
            ...
            const ctx = document.getElementById('chartComboDay');
            if (!ctx) return;
