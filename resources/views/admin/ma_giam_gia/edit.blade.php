...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-gradient mb-0">✏️ Cập nhật Mã Giảm Giá</h2>
    ...
    <div class="card border-0 shadow-lg rounded-4 p-4">
        <form action="{{ route('admin.ma_giam_gia.update', $maGiamGia->id) }}" method="POST" id="voucherForm">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="ma"
                        ...
                        value="{{ old('ma', $maGiamGia->ma) }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <select name="loai" id="loai"
                        ...
                        <option value="phan_tram" {{ old('loai', $maGiamGia->loai) == 'phan_tram' ? 'selected' : '' }}>Giảm theo %</option>
                        <option value="so_tien" {{ old('loai', $maGiamGia->loai) == 'so_tien' ? 'selected' : '' }}>Giảm theo số tiền</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" min="1" name="gia_tri"
                        ...
                        value="{{ old('gia_tri', $maGiamGia->gia_tri) }}" required>
                    @error('gia_tri') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                {{-- Giảm tối đa --}}
                <div class="col-md-4" id="giam_toi_da_wrapper"
                    style="display: {{ old('loai', $maGiamGia->loai) == 'phan_tram' ? 'block' : 'none' }};">
                ...
                <div class="col-md-4">
                    ...
                    <select name="ap_dung_cho"
                        ...
                        <option value="tat_ca" {{ old('ap_dung_cho', $maGiamGia->ap_dung_cho) == 'tat_ca' ? 'selected' : '' }}>Tất cả</option>
                        <option value="ve" {{ old('ap_dung_cho', $maGiamGia->ap_dung_cho) == 've' ? 'selected' : '' }}>Vé</option>
                        <option value="san_pham" {{ old('ap_dung_cho', $maGiamGia->ap_dung_cho) == 'san_pham' ? 'selected' : '' }}>Sản phẩm</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" min="1" name="so_luong"
                        ...
                        value="{{ old('so_luong', $maGiamGia->so_luong) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="ngay_bat_dau" id="ngay_bat_dau"
                        ...
                        value="{{ old('ngay_bat_dau', $maGiamGia->ngay_bat_dau ? \Carbon\Carbon::parse($maGiamGia->ngay_bat_dau)->format('Y-m-d') : '') }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="ngay_ket_thuc" id="ngay_ket_thuc"
                        ...
                        value="{{ old('ngay_ket_thuc', $maGiamGia->ngay_ket_thuc ? \Carbon\Carbon::parse($maGiamGia->ngay_ket_thuc)->format('Y-m-d') : '') }}">
            ...
            <div class="mt-5 text-end">
                <a href="{{ route('admin.ma_giam_gia.index') }}" class="btn btn-outline-secondary px-4 rounded-3 fw-semibold">
