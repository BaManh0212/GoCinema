...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('staff.phongchieu.index') }}" class="row g-3 align-items-center">
            ...
            {{-- Nút hành động --}}
             <div class="ms-auto text-end">
                    ...
                    <a href="{{ route('staff.phongchieu.index') }}" class="btn btn-outline-secondary shadow-sm rounded-pill px-4">Đặt lại</a>
            </div>
