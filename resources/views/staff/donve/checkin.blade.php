...
<div class="container mx-auto px-4">
    ...
    @php
        // Nếu đang ở prefix staff/* thì gửi tới staff route, ngược lại gửi tới staff route
        $actionRoute = request()->is('staff/*') ? route('staff.donve.checkinByCode') : route('staff.donve.checkinByCode');
    @endphp
