...
<div class="container mt-4">
    ...
    <div class="card mb-4 border-0 shadow-sm rounded-4">
        <div class="card-body">
            <form method="GET" action="{{ route('staff.donve.index') }}" class="row g-3 align-items-center">
                <div class="col-md-3">
                ...
                <div class="ms-auto text-end">
                    ...
                    <a href="{{ route('staff.donve.index') }}" class="btn btn-outline-secondary rounded-pill shadow-sm px-4">
                        ...
                        <tr class="table-row text-center">
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    @else
                                        <a href="{{ route('staff.donve.show', $don->id) }}" class="btn btn-sm btn-info text-white rounded-pill px-3 shadow-sm">
                                            <i class="bi bi-eye"></i> Xem
                                        </a>
                                        @php $canPrint = in_array($don->trang_thai, ['da_thanh_toan','da_checkin']); @endphp
                                        @if($canPrint)
                                            <a href="{{ route('staff.donve.print', $don->id) }}" class="btn btn-sm btn-success rounded-pill px-3 shadow-sm">
                                                <i class="bi bi-printer"></i> In vé
                                            </a>
                                        @else
