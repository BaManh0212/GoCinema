                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Doanh thu vé (Tháng)</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">5,000,000đ</div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Doanh thu combo (Tháng)</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">2,150,000đ</div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    Doanh thu sản phẩm (Tháng)</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">1,200,000đ</div>
                            </div>
                            <div class="col-auto">
