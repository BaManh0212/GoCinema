...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('staff.combo.index') }}" class="btn btn-outline-secondary rounded-pill shadow-sm">
            ⬅ Quay lại danh sách
        </a>
    </div>
    ...
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-body p-4">
            <form action="{{ route('staff.combo.update', $combo->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
