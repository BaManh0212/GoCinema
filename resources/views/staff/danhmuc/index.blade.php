...
<div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('staff.danhmuc.index') }}" class="row g-3 align-items-center">
                <div class="col-auto">
                ...
                <div class="ms-auto text-end">
                    ...
                    <a href="{{ route('staff.danhmuc.index') }}" class="btn btn-outline-secondary shadow-sm rounded-pill px-4">Đặt lại</a>
                </div>
            </form>
                        ...
                        <tr class="table-row">
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    {{-- 👁️ Nút xem chi tiết --}}
                                    <a href="{{ route('staff.danhmuc.show', $dm->id) }}" 
