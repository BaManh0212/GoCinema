...
@section('content')
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="{{ route('staff.phim.index') }}" class="btn btn-secondary">← Quay về danh sách</a>
        </div>
                    ...
                    <tbody>
                        @forelse($phims as $phim)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('staff.phim.restore', $phim->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('PUT')
