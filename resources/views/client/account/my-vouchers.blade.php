...
<style>
  ...
  .account-sidebar .profile-top{ padding:28px 20px; text-align:center; border-bottom:1px solid var(--border); }
  ...
  .account-sidebar .list-group a{
    ...
    border-radius:10px; color:var(--muted); font-weight:600; text-decoration:none;
    ...
    <div class="col-lg-3 col-md-4">
      <aside class="account-sidebar">
        ...
        <div class="list-group">
          ...
          <a href="{{ route('account.my-vouchers') }}" class="active"><i class="fas fa-ticket-alt"></i> Voucher của tôi</a>
